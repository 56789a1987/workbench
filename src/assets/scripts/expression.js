...
var Expression = function() {
    ...
    var operators = {
        ...
        '/' : new OperatorToken(' / ', evalDivide, 2, 'left', 20),
    ...
    var functions = {
        ...
        '10_x' : new FunctionToken('10^', eval10x, 1, 'left', 50),
        'abs' : new FunctionToken('abs', evalAbs, 1, 'left', 50)
    };
    
    var constants = {
        'pi' : new NumberToken(Math.PI, '&pi;'),
        'e' : new NumberToken(Math.E, 'e')
    }
